...
function Modal({ children, toggle = () => {}, cont = () => {} }) {
      ...
      <div className="flex items-center justify-center min-h-full p-4 text-center sm:p-0">
        <div onClick={(e) => e.stopPropagation()} className="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all w-full sm:my-8 sm:max-w-3xl sm:w-full">
          ...
          <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            <button onClick={() => { toggle(false); cont(); }} type="button" className="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-tpi-blue text-base font-medium text-gray-700 hover:bg-blue-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">Continue</button>
